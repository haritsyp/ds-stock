...
class SupplierCrudController extends CrudController
{
    ...
    public function store()
    {
        ...
        $requestOnly = $this->crud->getStrippedSaveRequest();
        $requestOnly['code'] = IdGenerator::generate(['table' => 'suppliers', 'field' => 'code', 'length' => 6, 'prefix' => 'S']);
        // insert item in the db
        $item = $this->crud->create($requestOnly);
